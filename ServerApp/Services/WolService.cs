...
namespace ServerWizard.Services
{
    public class WolService
    {
        ...
        public async Task WakeOnLan(string macAddress)
        {
        ...
        byte[] BuildMagicPacket(string macAddress) // MacAddress in any standard HEX format
        {
        ...
        async Task SendWakeOnLan(IPAddress localIpAddress, IPAddress multicastIpAddress, byte[] magicPacket)
        {
